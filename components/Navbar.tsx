...
export default function Navbar() {
  ...
  return (
    <div className="fixed top-0 left-0 w-full z-50 flex justify-center pt-4 md:pt-6 pointer-events-none px-4">
      <nav className="pointer-events-auto bg-slate-950/50 backdrop-blur-xl border border-white/5 rounded-full px-1 py-1 md:px-2 md:py-2 flex items-center shadow-2xl max-w-full overflow-x-auto">
