    ...
    <div className="relative w-full max-w-[540px] aspect-square mx-auto flex items-center justify-center select-none">
      ...
      >
        ...
        <path
          d="
            M175 188
            C204 137 258 135 299 158
            C337 179 362 151 397 166
            C438 184 447 227 428 263
            C412 293 438 327 421 365
            C400 411 351 420 310 398
            C273 378 242 403 207 382
            C169 360 164 317 179 283
            C194 250 154 224 175 188Z
          "
          fill="#E86F2D"
          fillOpacity="0.92"
        ...
        {/* SECONDARY PAPER SHAPE */}
        <path
          d="
            M135 258
            C150 196 202 145 270 130
            C343 114 420 143 461 201
            C502 258 499 338 458 399
            C416 462 334 488 263 464
            C192 440 143 384 132 321
            C128 298 130 276 135 258Z
          "
          fill="#FFFDF8"
          fillOpacity="0.34"
        />
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-10">
        <img
          ...
          alt="Krish D Shah"
          className="w-[72%] h-[82%] object-contain translate-y-[2%]"
        />
      </div>

      {/* Sticky Note Card (bottom-right) */}
      <div className="absolute bottom-[2%] right-[-1%] z-20 max-w-[210px] sm:max-w-[235px] transform rotate-[3deg] transition-transform duration-300 hover:rotate-0 drop-shadow-xl pointer-events-auto">
